...
describe('assignForegrounds', () => {
  it('assigns foreground to all shades in a palette', () => {
    const palette = generatePalette({ hue: 230, chroma: 0.15, anchorLightness: 0.55 })
  ...
  it('ensures chosen foreground provides at least 3:1 contrast for all shades', () => {
    const seeds = [
      { hue: 230, chroma: 0.15, anchorLightness: 0.55 },
      { hue: 25, chroma: 0.18, anchorLightness: 0.55 },
      { hue: 145, chroma: 0.14, anchorLightness: 0.55 },
      { hue: 75, chroma: 0.15, anchorLightness: 0.55 },
    ]
